...
class RegisterLocalRepository implements IRegisterRepository {
    final IRegisterLocalDataSource _registerLocalDataSource;

    RegisterLocalRepository({required IRegisterLocalDataSource registerLocalDataSource}) : _registerLocalDataSource = registerLocalDataSource;
